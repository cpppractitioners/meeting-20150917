...
extern "C" {
inline void ktl_psignals_signal_handler(int signum) {}
}
...
inline void set_action(const sigset &signals)
{
    ...
    action.sa_handler = &::ktl_psignals_signal_handler;
    action.sa_flags = 0;
...
inline signum_t wait(const sigset &signals, ::siginfo *info = nullptr)
{
...
#endif  // _KTL_PSIGNALS_PSIGNALS_HPP_
